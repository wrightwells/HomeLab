...
| --- | --- | --- | --- | --- | --- |
| `ollama` | `vm210-ai-gpu` | `10.10.20.210` | `http://ai-gpu.bandicoot-pumpkinseed.ts.net:11434` | `11434` | Local LLM inference API for coding, chat, OCR, and automations |
| `open-webui` | `vm210-ai-gpu` | `10.10.20.210` | `http://ai-gpu.bandicoot-pumpkinseed.ts.net:3000` | `3000` | Browser UI and OpenAI-compatible API front door for Ollama models |
| `frigate` | `vm210-ai-gpu` | `10.10.20.210` | `http://ai-gpu.bandicoot-pumpkinseed.ts.net:5000` | `5000` default | NVR, object detection, and camera event review |
| `homeassistant` | `vm210-ai-gpu` | `10.10.20.210` | `http://ai-gpu.bandicoot-pumpkinseed.ts.net:8123` | `8123` default | Home automation, device integrations, dashboards |
| `wyoming-piper` | `vm210-ai-gpu` | `10.10.20.210` | `tcp://ai-gpu.bandicoot-pumpkinseed.ts.net:10200` | `10200` | Local Wyoming TTS service for Assist voice replies |
...
| `sonarr` | `lxc066-docker-arr` | `10.10.66.66` | `http://docker-arr.bandicoot-pumpkinseed.ts.net:8989` | `8989` | TV automation |
| `radarr` | `lxc066-docker-arr` | `10.10.66.66` | `http://docker-arr.bandicoot-pumpkinseed.ts.net:7878` | `7878` | Movie automation |
| `lidarr` | `lxc066-docker-arr` | `10.10.66.66` | `http://docker-arr.bandicoot-pumpkinseed.ts.net:8686` | `8686` | Music automation |
| `bazarr` | `lxc066-docker-arr` | `10.10.66.66` | `http://docker-arr.bandicoot-pumpkinseed.ts.net:6767` | `6767` | Subtitle management |
| `readarr` | `lxc066-docker-arr` | `10.10.66.66` | `http://docker-arr.bandicoot-pumpkinseed.ts.net:8787` | `8787` | Book and ebook automation |
...
| `owncloud` | `lxc200-docker-services` | `10.10.20.200` | `http://docker-services.bandicoot-pumpkinseed.ts.net:9090` | `9090` | File sync and collaboration |
...
| `paperless` | `lxc200-docker-services` | `10.10.20.200` | `http://docker-services.bandicoot-pumpkinseed.ts.net:8000` | `8000` | Document management, OCR, and inbox workflow for scanned files |
...
| `calibre` | `lxc220-docker-apps` | `10.10.20.220` | `http://docker-apps.bandicoot-pumpkinseed.ts.net:8083` | `8083`, `8181` | Calibre server and ebook management |
| `erugo` | `lxc220-docker-apps` | `10.10.20.220` | `http://docker-apps.bandicoot-pumpkinseed.ts.net:9998` | `9998` | General web application storage/service |
| `firefly_iii_core` | `lxc220-docker-apps` | `10.10.20.220` | `http://docker-apps.bandicoot-pumpkinseed.ts.net:8011` | `8011` | Personal finance tracking |
| `firefly_iii_db` | `lxc220-docker-apps` | `10.10.20.220` | `internal-only` | `N/A` | Firefly III database |
| `grafana` | `lxc220-docker-apps` | `10.10.20.220` | `http://docker-apps.bandicoot-pumpkinseed.ts.net:3000` | `3000` | Dashboards and metrics visualization |
| `grist` | `lxc220-docker-apps` | `10.10.20.220` | `http://docker-apps.bandicoot-pumpkinseed.ts.net:8484` | `8484` | Spreadsheet/database hybrid app |
| `homarr` | `lxc220-docker-apps` | `10.10.20.220` | `http://docker-apps.bandicoot-pumpkinseed.ts.net:7575` | `7575` | Homelab dashboard |
...
| `ghost` | `lxc240-docker-external` | `10.10.66.240` | `http://docker-external.bandicoot-pumpkinseed.ts.net:2368` | `2368` | Ghost blog/CMS |
| `kutt` | `lxc240-docker-external` | `10.10.66.240` | `http://docker-external.bandicoot-pumpkinseed.ts.net:7070` | `7070` | URL shortener |
| `nginx` | `lxc240-docker-external` | `10.10.66.240` | `http://docker-external.bandicoot-pumpkinseed.ts.net` / `https://docker-external.bandicoot-pumpkinseed.ts.net` | `80`, `443` | Reverse proxy and public entry point |
...
| `mosquitto` | `lxc250-infra` | `10.10.20.250` | `mqtt://infra.bandicoot-pumpkinseed.ts.net:1883` | `1883`, `9001` | MQTT broker for automation and sensors |
| `portainer` | `lxc250-infra` | `10.10.20.250` | `https://infra.bandicoot-pumpkinseed.ts.net:9443` | `9443`, `8001` | Docker management UI for local container administration |
| `prometheus` | `lxc250-infra` | `10.10.20.250` | `http://infra.bandicoot-pumpkinseed.ts.net:9090` | `9090` | Metrics scraping and storage |
| `ansible-semaphore` | `lxc250-infra` | `10.10.20.250` | `http://infra.bandicoot-pumpkinseed.ts.net:3002` | `3002` | Ansible job UI and automation runner |
| `uptime-kuma` | `lxc250-infra` | `10.10.20.250` | `http://infra.bandicoot-pumpkinseed.ts.net:3001` | `3001` | Uptime monitoring and status checks |
