...
# (vmbr0, 10.10.1.10) to the management VLAN behind pfSense (vmbr2.99, 10.10.99.110).
#
# IMPORTANT: After running this script, your SSH session will disconnect.
# Reconnect using the new IP: ssh root@10.10.99.110
#
...
echo "Reconnect to the new IP: ssh root@10.10.99.110"
...
echo "This will disconnect your SSH session. Reconnect to 10.10.99.110."
...
echo "If disconnected, reconnect: ssh root@10.10.99.110"
