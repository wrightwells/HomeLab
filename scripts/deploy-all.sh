...
echo "You must now:"
echo "  1. Boot VM 100 from the imported Netgate .img installer disk"
echo "  2. Install pfSense to scsi0 from the Proxmox console"
echo "  3. Switch boot order back to scsi0 and remove the installer disk"
